/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --strict-vars=false` (hash: c195a19486f75380e9f6e977e03b83b3)
// Runtime types generated with workerd@1.20260910.1 2026-09-11 nodejs_compat
interface __BaseEnv_Env {
	PRODUCT_IMAGES: R2Bucket;
	DB: D1Database;
	CATALOG_INDEX: VectorizeIndex;
	MESSAGE_QUEUE: Queue;
	CATALOG_QUEUE: Queue;
	AI: Ai;
	ASSETS: Fetcher;
	...
	DEBOUNCE_MS: string;
	DEBOUNCE_MAX_MS: string;
	TOKEN_KEY_VERSION: string;
	IMAGE_MAX_BYTES: string;
	IMAGE_PROBABLE_THRESHOLD: string;
	IMAGE_SIMILAR_THRESHOLD: string;
	IMAGE_NEAR_DUPLICATE_DISTANCE: string;
	MESSENGER_WINDOW_HOURS: string;
	AUTH_FACEBOOK_ID: string;
	AUTH_FACEBOOK_GRAPH_API_VERSION: string;
	AI_ENABLED: string;
	...
	CONVERSATIONS: DurableObjectNamespace<import("./src/worker/index").ConversationDO>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_MODE" | "APP_ORIGIN" | "META_GRAPH_API_VERSION" | "META_APP_ID" | "META_LOGIN_CONFIG_ID" | "AI_GATEWAY_ID" | "CHAT_MODEL" | "VISION_MODEL" | "EMBEDDING_MODEL" | "RERANK_MODEL" | "EMBEDDING_DIMENSIONS" | "DEBOUNCE_MS" | "DEBOUNCE_MAX_MS" | "TOKEN_KEY_VERSION" | "IMAGE_MAX_BYTES" | "IMAGE_PROBABLE_THRESHOLD" | "IMAGE_SIMILAR_THRESHOLD" | "IMAGE_NEAR_DUPLICATE_DISTANCE" | "MESSENGER_WINDOW_HOURS" | "AUTH_FACEBOOK_ID" | "AUTH_FACEBOOK_GRAPH_API_VERSION" | "AI_ENABLED" | "MESSAGING_ENABLED" | "META_APP_SECRET" | "META_WEBHOOK_VERIFY_TOKEN" | "TOKEN_ENCRYPTION_KEY" | "SESSION_SIGNING_SECRET" | "MOCK_APP_ORIGINS">> {}
}
